...
const Profile = () => {
	...
	const [prof, setProf] = useState({
		username: prof_data.username || 'username',
		email: prof_data.email || 'example@gmail.com',
		marital: prof_data.marital || 'single,married etc',
		occupation: prof_data.occupation || 'Doctor,tout, etc',
		city: prof_data.city || 'Nairobi,Nakuru,etc',

		password: prof_data.password || '12345',
		confirmpassword: prof_data.password || '12345',
	});
