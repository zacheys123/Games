...
const Profile = () => {
	...
	const [prof, setProf] = useState({
		username: rprof_data.username,
		email: rprof_data.email,
		marital: rprof_data.marital || '',
		occupation: rprof_data.occupation,
		city: rprof_data.city,
		package: rprof_data.package,
		password: rprof_data.password,
		confirmpassword: rprof_data.password,
	});
