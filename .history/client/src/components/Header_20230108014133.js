...
const Header = (props) => {
	const {
		main: { istheme, contact, auth, userInfo, showmenu, prof_data },
		setMainContext,
	} = useMainContext();
							...
							>
								...
								>
									...
									<Button
										...
										className={userInfo ? 'item' : 'disabled'}
										variant="outlined"
										size="small"
									>
										Game
								...
								<li
									ref={summary}
									className={user?.result?._id ? userInfo ? 'item' :'disabled : 'disabled'}
								>
									{' '}
									<Button
										onClick={() => {
