...
const Score = (props) => {
	...
	const game = JSON.parse(window.localStorage.getItem('games'));
		...
		<Stack direction="column" className="">
			<Box className="main__score">
				<Box className="player1">
					<h6 style={{ color: 'red' }}>
						{props.mygames?.player1?.toUpperCase()}
					</h6>
					<input
						type="text"
						disabled
						className="player1"
						name="player1_team"
						value={props.mygames?.player1_team}
				...
				<Box className="player2">
					{' '}
					<h6 style={{ color: 'red' }}>
						{props.mygames?.player2?.toUpperCase()}
					</h6>
					<input
						disabled
						type="text"
						className="player2"
						name="player2_team"
						value={props.mygames?.player2_team}
